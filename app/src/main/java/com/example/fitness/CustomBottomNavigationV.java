...
public class CustomBottomNavigationV extends BottomNavigationView {
    private Path mPath;
    ...
    public CustomBottomNavigationV(Context context) {
        super(context);
        init();
    }

    public CustomBottomNavigationV(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }

    public CustomBottomNavigationV(Context context, AttributeSet attrs, int defStyleAttr) {
